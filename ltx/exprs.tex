...
\ifcSortSection{Select}{DyadicOperator} Use of the scope resolution operator ``\code{::}'' as source level.
The first operand designates the scope, and the second operand designates the member to selct
