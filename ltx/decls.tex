...
\begin{description}
	...
	\item \code{FunctionTraits::NoReturn}: the function is declared \code{[[noreturn]]} or \code{\_\_declspec(noreturn)}.  Note: this trait will be removed in future releases in favor of attributes.
	\item \code{FunctionTraits::PureVirtual}: the function is pure virtual, e.g. with \code{ = 0}
	\item \code{FunctionTraits::HiddenFriend}: the function is a hidden friend.  Note: this trait will be removed in future releases.
	...
	\item \code{FunctionTraits::Final}: the function is declared as `final`.
	\item \code{FunctionTraits::Override}: the function is declared as `override`.
